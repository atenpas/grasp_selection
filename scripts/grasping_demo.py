...
class Grasping():
  ...
  def run(self):
    ...
    self.pub = rospy.Publisher('/robot/limb/right/joint_command', JointCommand)
    ...
    try:
      ...
      env.StopSimulation()
      env.Load("/home/baxter/baxter_ws/src/grasping_demo/trajopt/manipulator_baxter.xml")
      env.Load("/home/baxter/baxter_ws/src/grasping_demo/trajopt/table.xml")
